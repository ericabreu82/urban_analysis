...
#ifndef __URBANANALYSIS_INTERNAL_GROWTH_QT_CONFIG_H
#define __URBANANALYSIS_INTERNAL_GROWTH_QT_CONFIG_H
...
*/
  ...
  #ifdef TEGROWTHQTSTATIC
    #define TEGROWQTTHEXPORT                          // Don't need to export/import... it is a static library
  #elif TEGROWTHQTDLL
    #define TEGROWTHQTEXPORT  __declspec(dllexport)   // export DLL information
  #else
    #define TEGROWTHQTEXPORT  __declspec(dllimport)   // import DLL information
  #endif 
#else
    #define TEGROWTHQTEXPORT
#endif

//@}

#endif  // __URBANANALYSIS_INTERNAL_GROWTHQT_CONFIG_H
